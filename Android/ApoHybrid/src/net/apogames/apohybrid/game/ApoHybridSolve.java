		...
		for (int y = 0; y < 8; y++) {
			for (int x = 0; x < level[y].length; x++) {
				if (level[y + 8][x] >= 3) {
					...
					if (north > 0) {
//						BitsLog.d("test", net.apogames.apohybrid.net.apogames.apohybrid.level[13][0]+" "+net.apogames.apohybrid.net.apogames.apohybrid.level[14][0]+" "+net.apogames.apohybrid.net.apogames.apohybrid.level[15][0]);
...
//						BitsLog.d("test", net.apogames.apohybrid.net.apogames.apohybrid.level[13][0]+" "+net.apogames.apohybrid.net.apogames.apohybrid.level[14][0]+" "+net.apogames.apohybrid.net.apogames.apohybrid.level[15][0]);
//						this.setNorthBack(net.apogames.apohybrid.net.apogames.apohybrid.level, x, y, north);
//						BitsLog.d("test", net.apogames.apohybrid.net.apogames.apohybrid.level[13][0]+" "+net.apogames.apohybrid.net.apogames.apohybrid.level[14][0]+" "+net.apogames.apohybrid.net.apogames.apohybrid.level[15][0]);
					}
					int east = this.isEastFree(level, x, y);
					if (east > 0) {
//						BitsLog.d("test", "before "+net.apogames.apohybrid.net.apogames.apohybrid.level[15][0]+" "+net.apogames.apohybrid.net.apogames.apohybrid.level[15][1]+" "+net.apogames.apohybrid.net.apogames.apohybrid.level[15][2]);
						int[][] clone = this.getClone(level);
						clone[y + 8][x] = (byte)(clone[y + 8][x] - 1);
...
//						BitsLog.d("test", "mid "+net.apogames.apohybrid.net.apogames.apohybrid.level[15][0]+" "+net.apogames.apohybrid.net.apogames.apohybrid.level[15][1]+" "+net.apogames.apohybrid.net.apogames.apohybrid.level[15][2]);
//						this.setEastBack(net.apogames.apohybrid.net.apogames.apohybrid.level, x, y, east);
//						BitsLog.d("test", "after "+net.apogames.apohybrid.net.apogames.apohybrid.level[15][0]+" "+net.apogames.apohybrid.net.apogames.apohybrid.level[15][1]+" "+net.apogames.apohybrid.net.apogames.apohybrid.level[15][2]);
					}
...
//						this.setSouthBack(net.apogames.apohybrid.net.apogames.apohybrid.level, x, y, south);
//						BitsLog.d("test", net.apogames.apohybrid.net.apogames.apohybrid.level[13][0]+" "+net.apogames.apohybrid.net.apogames.apohybrid.level[14][0]+" "+net.apogames.apohybrid.net.apogames.apohybrid.level[15][0]);
					}
...
//						this.setWestBack(net.apogames.apohybrid.net.apogames.apohybrid.level, x, y, west);
					}
				}
			}
		}
