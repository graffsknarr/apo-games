...
public class ApoHybridArcardeGame extends ApoHybridModel {
	...
	public ApoHybridArcardeGame(ApoHybridPanel game) {
		super(game);
	}

	@Override
	public void init() {		
		this.getStringWidth().put(ApoHybridGame.BACK, (int)(ApoHybridPanel.font.getLength(ApoHybridPuzzleGame.BACK)));
		
		String s = "ApoHybrid - Arcarde";
	...
	public void touchedButton(String function) {
		if (function.equals(ApoHybridArcardeGame.BACK)) {
	...
	public void render(BitsGLGraphics g) {
		...
		if (p[3] > 0) {
			...
			this.getGame().drawString(g, s, 240, 282, ApoHybridPanel.game_font);
		} else {
			if (p[2] <= 0) {
				s = "Touch to start the game";
				this.getGame().drawString(g, s, 190, 598, ApoHybridPanel.game_font);
