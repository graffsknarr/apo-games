...
//@	
//@	public ApoHybridGame(final ApoHybridPanel game) {
//@		super(game);
//@	}
//@
//@	@Override
...
//@			points[1] = new ApoHybridTutorialHelp(20, 224, 64, 224, 0);
//@			points[2] = new ApoHybridTutorialHelp(20, 224, 96, 224, 1000);
//@			points[3] = new ApoHybridTutorialHelp(20, 224, 64, 224, 750);
...
//@					if (level < 0) {
//@						level = ApoHybridLevel.editorLevels.length - 1;
//@					}
//@					if (level >= ApoHybridLevel.editorLevels.length) {
//@						level = 0;
//@					}
//@					levelString = ApoHybridLevel.editorLevels[level];
//@				} else {
//@					level = 0;
//@					levelString = ApoHybridLevel.getLevel(level);
//@				}
//@			} else {
...
//@					level = 0;
//@				}
//@				levelString = ApoHybridLevel.getLevel(level + start);
//@			}
//@		}
//@		this.levelString = levelString;
//@		
...
//@				this.lights[y][x] = 0;
//@				if ((y < 4) || (y > 10)) {
//@					if ((this.curLevel == 0) && (this.getGame().getDifficulty() == ApoHybridLevelChooser.EASY)) {
//@						
...
//@	@Override
//@	public void touchedButton(String function) {
//@		if ((function.equals(ApoHybridGame.BACK)) || (function.equals(ApoHybridGame.RESULT_MENU))) {
//@			this.getGame().playSound(ApoHybridSoundPlayer.SOUND_CLICK);
//@			this.onBackButtonPressed();
//@		} else if ((function.equals(ApoHybridGame.INGAME_RESTART)) || (function.equals(ApoHybridGame.RESULT_RESTART))) {
//@			this.getGame().playSound(ApoHybridSoundPlayer.SOUND_CLICK);
//@			this.restartLevel();
//@		} else if ((function.equals(ApoHybridGame.INGAME_NEXT)) || (function.equals(ApoHybridGame.RESULT_NEXT))) {
//@			this.getGame().playSound(ApoHybridSoundPlayer.SOUND_CLICK);
//@			this.loadNextLevel();
//@		} else if (function.equals(ApoHybridGame.INGAME_PREVIOUS)) {
//@			this.getGame().playSound(ApoHybridSoundPlayer.SOUND_CLICK);
//@			this.loadPreviousLevel();
//@		} else if (function.equals(ApoHybridGame.INGAME_MUSIC)) {
//@			this.getGame().setMusic(!this.getGame().getButtons()[24].isSelected());
//@		} else if (function.equals(ApoHybridGame.INGAME_SOUND)) {
...
//@			if (x < ApoHybridConstants.GAME_WIDTH/2) {
//@				this.rotateLeft();
//@			} else {
//@				this.rotateRight();
//@			}
...
//@				ApoHybridConstants.FIRST_GAME = false;
//@			}
//@		}
//@		
...
//@				} else {
//@					this.idleTime += delta;
//@					if ((this.idleTime - delta < ApoHybridConstants.START_IDLE_TEXT_TIME) && (this.idleTime >= ApoHybridConstants.START_IDLE_TEXT_TIME)) {
//@						this.idleString = ApoHybridConstants.TEXT_IDLE[(int)(Math.random() * ApoHybridConstants.TEXT_IDLE.length)];
//@					}
//@					if ((this.idleTime - delta < ApoHybridConstants.END_IDLE_TEXT_TIME) && (this.idleTime >= ApoHybridConstants.END_IDLE_TEXT_TIME)) {
//@						this.idleString = "";
//@						this.idleTime = 0;
//@					}
//@				}
...
//@				bVisible = false;
//@				
//@				this.idleString = ApoHybridConstants.TEXT_WIN[(int)(Math.random() * ApoHybridConstants.TEXT_WIN.length)];
//@			}
...
//@				} else if (this.steps <= this.silver) {
//@					this.getGame().playSound(ApoHybridSoundPlayer.SOUND_WIN_2);
//@				} else {
//@					this.getGame().playSound(ApoHybridSoundPlayer.SOUND_WIN_1);
//@				}
//@			}
//@		}
//@	}
...
//@		// Renderabschnitt
//@		// Hintergrund malen
//@//		g.cropImage(this.screenBackground, 0, 0, ApoHybridConstants.GAME_WIDTH, ApoHybridConstants.GAME_HEIGHT, 0, 0, ApoHybridConstants.GAME_WIDTH, ApoHybridConstants.GAME_HEIGHT);
//@
//@		for (int y = 1; y < 15; y += 1) {
//@			for (int x = 0; x < 10; x += 1) {
//@				g.cropImage(ApoHybridConstants.iSheet, (x) * 32, (y) * 32, 32, 32, (int)(this.levelRandom[y][x]) * 32, 3 * 32, 32, 32);
//@			}
//@		}
//@		g.cropImage(ApoHybridConstants.iSheet, 0, 0, 192, 32, 0, 128, 192, 32);
//@		g.cropImage(ApoHybridConstants.iSheet, 192, 0, 64, 32, 128, 64, 64, 32);
//@		g.cropImage(ApoHybridConstants.iSheet, 256, 0, 64, 32, 128, 96, 64, 32);
//@		
//@		g.cropImage(ApoHybridConstants.iSheet, 0, 448, 320, 32, 384, 480, 320, 32);
//@		
//@		for (int y = 1; y < this.lights.length; y += 1) {
//@			for (int x = 0; x < this.lights[0].length; x += 1) {
//@				if (this.lights[y][x] > 0) {
//@					g.cropImage(ApoHybridConstants.iSheet, (x) * 32 - 16, (y) * 32 - 16, 64, 64, 8 * 32, 32, 64, 64);
//@					if (this.lights[y][x] > 450) {
//@						g.cropImage(ApoHybridConstants.iSheet, (x) * 32, (y) * 32, 32, 32, 1 * 32, 0 * 32, 32, 32);
//@					} else {
//@						g.cropImage(ApoHybridConstants.iSheet, (x) * 32, (y) * 32, 32, 32, 3 * 32, 1 * 32, 32, 32);
//@					}
//@				}
//@			}
//@		}
...
//@		int i = ApoHybridConstants.GAME_WIDTH/2 - this.level[0].length * 16;
//@		int j = ApoHybridConstants.GAME_HEIGHT/2 - this.level.length/2 * 16;
//@		if (this.state == 0) {
//@			g.setRotation(90 * this.gravity - this.turn, ApoHybridConstants.GAME_WIDTH/2, ApoHybridConstants.GAME_HEIGHT/2);
//@			
//@			for (int y = 0; y < this.level.length/2; y += 1) {
//@				for (int x = 0; x < this.level[0].length; x += 1) {
//@					if (this.level[y][x] == 3) {
//@						g.cropImage(ApoHybridConstants.iSheet, i + (x) * 32 - 16, j +(y) * 32 - 16, 64, 64, 8 * 32, 32, 64, 64);
//@						g.cropImage(ApoHybridConstants.iSheet, i + (x) * 32, j + (y) * 32, 32, 32, 0 * 32, 1 * 32, 32, 32);
//@					}
//@					if (this.level[y][x] == 4) {
//@						g.cropImage(ApoHybridConstants.iSheet, i + (x) * 32 + (int)(this.levelBlocks[y+this.levelBlocks.length/2][x]), j + (y) * 32 + (int)(this.levelBlocks[y][x]), 32, 32, 2 * 32, 0 * 32, 32, 32);
//@					}
//@					if (this.level[y][x] == 0) {
//@						g.cropImage(ApoHybridConstants.iSheet, i + (x) * 32, j + (y) * 32, 32, 32, this.level[y + this.level.length/2][x] * 32, 2 * 32, 32, 32);
//@					}
//@					if (this.level[y][x] == 2) {
//@						playerX = x;
//@						playerY = y;
...
//@							}
//@						}
//@						g.cropImage(ApoHybridConstants.iSheet, i + (x) * 32 + (int)(this.levelBlocks[y+this.levelBlocks.length/2][x]), j + (y) * 32 + (int)(this.levelBlocks[y][x]), 32, 32, curX * 32, curY * 32, 32, 32);
//@					}
//@				}
//@			}
//@			g.setRotation(0, ApoHybridConstants.GAME_WIDTH/2, ApoHybridConstants.GAME_HEIGHT/2);
//@			
//@			if (this.gravity == 1) {
//@				int save = playerY;
//@				playerY = playerX;
...
//@			g.drawText(s, 160 - w/2, 96 - ApoHybridConstants.fontBig.mCharCellHeight);
//@			
//@			g.setFont(ApoHybridConstants.fontMedium);
//@
//@			s = "You needed";
//@			w = ApoHybridConstants.fontMedium.getLength(s);
//@			g.drawText(s, 160 - w/2, 244 - ApoHybridConstants.fontMedium.mCharCellHeight);
//@			
//@			s = "moves.";
//@			w = ApoHybridConstants.fontMedium.getLength(s);
//@			g.drawText(s, 160 - w/2, 304 - ApoHybridConstants.fontMedium.mCharCellHeight);
//@			
//@			if (this.steps <= this.gold) {
...
//@			w = ApoHybridConstants.fontMedium.getLength(s);
//@			g.drawText(s, 160 - w/2, 274 - ApoHybridConstants.fontMedium.mCharCellHeight);
//@			
//@			g.setColor(1f,1f,1f,1f);
//@			g.cropImage(ApoHybridConstants.iSheet, 24, 240, 64, 64, 8 * 32, 32, 64, 64);
//@			if (this.lights[0][1] > 450) {
//@				g.cropImage(ApoHybridConstants.iSheet, 40, 256, 32, 32, 1 * 32, 0 * 32, 32, 32);
//@			} else {
//@				g.cropImage(ApoHybridConstants.iSheet, 40, 256, 32, 32, 3 * 32, 1 * 32, 32, 32);
//@			}
//@			
//@			
//@			g.cropImage(ApoHybridConstants.iSheet, 240, 240, 64, 64, 8 * 32, 32, 64, 64);
//@			if (this.lights[0][0] > 450) {
//@				g.cropImage(ApoHybridConstants.iSheet, 256, 256, 32, 32, 1 * 32, 0 * 32, 32, 32);
//@			} else {
//@				g.cropImage(ApoHybridConstants.iSheet, 256, 256, 32, 32, 3 * 32, 1 * 32, 32, 32);
//@			}
//@			
//@			if (this.lights[0][2] > 450) {
//@				g.cropImage(ApoHybridConstants.iSheet, 144, 144, 32, 32, 4 * 32, 1 * 32, 32, 32);
//@			} else {
//@				g.cropImage(ApoHybridConstants.iSheet, 144, 144, 32, 32, 5 * 32, 1 * 32, 32, 32);
//@			}
//@			this.drawSpeech(g, 144, 140);
//@			
//@			g.cropImage(ApoHybridConstants.iSheet, 80, 144, 32, 32, 2 * 32, 0 * 32, 32, 32);
//@			g.cropImage(ApoHybridConstants.iSheet, 208, 144, 32, 32, 2 * 32, 0 * 32, 32, 32);
//@			
//@			if (this.steps <= this.gold) {
//@				g.cropImage(ApoHybridConstants.iSheet, 108 - 16, 332- 16, 64, 64, 8 * 32, 32, 64, 64);
//@				g.cropImage(ApoHybridConstants.iSheet, 108, 332, 32, 32, 0 * 32, 1 * 32, 32, 32);
//@				g.cropImage(ApoHybridConstants.iSheet, 144 - 16, 332- 16, 64, 64, 8 * 32, 32, 64, 64);
//@				g.cropImage(ApoHybridConstants.iSheet, 144, 332, 32, 32, 0 * 32, 1 * 32, 32, 32);
//@				g.cropImage(ApoHybridConstants.iSheet, 180 - 16, 332- 16, 64, 64, 8 * 32, 32, 64, 64);
//@				g.cropImage(ApoHybridConstants.iSheet, 180, 332, 32, 32, 0 * 32, 1 * 32, 32, 32);
//@			} else if (this.steps <= this.silver) {
//@				g.cropImage(ApoHybridConstants.iSheet, 126 - 16, 332- 16, 64, 64, 8 * 32, 32, 64, 64);
//@				g.cropImage(ApoHybridConstants.iSheet, 126, 332, 32, 32, 6 * 32, 1 * 32, 32, 32);
//@				g.cropImage(ApoHybridConstants.iSheet, 162 - 16, 332- 16, 64, 64, 8 * 32, 32, 64, 64);
//@				g.cropImage(ApoHybridConstants.iSheet, 162, 332, 32, 32, 6 * 32, 1 * 32, 32, 32);
//@			} else {
//@				g.cropImage(ApoHybridConstants.iSheet, 144 - 16, 332- 16, 64, 64, 8 * 32, 32, 64, 64);
//@				g.cropImage(ApoHybridConstants.iSheet, 144, 332, 32, 32, 1 * 32, 1 * 32, 32, 32);
//@			}
//@		} else if ((!this.bEditor) && (!this.bUserLevel)) {
//@			if ((this.curLevel == 0) && (this.getGame().getDifficulty() == ApoHybridLevelChooser.EASY)) {
//@				g.setColor(175,175,175);
//@				g.setFont(ApoHybridConstants.fontMedium);
//@				for (i = 0; i < ApoHybridConstants.FIRST_COLLECT.length; i++) {
//@					s = ApoHybridConstants.FIRST_COLLECT[i];
//@					w = ApoHybridConstants.fontMedium.getLength(s);
//@					g.drawText(s, ApoHybridConstants.GAME_WIDTH/2 - w/2, 65 + 40 * i - ApoHybridConstants.fontMedium.mCharCellHeight);
//@				}
//@				
//@				g.setFont(ApoHybridConstants.fontVerySmall);
//@				for (i = 0; i < ApoHybridConstants.FIRST_MOVE.length; i++) {
//@					s = ApoHybridConstants.FIRST_MOVE[i];
//@					w = ApoHybridConstants.fontVerySmall.getLength(s);
//@					g.drawText(s, ApoHybridConstants.GAME_WIDTH/2 - w/2, 355 + 22 * i - ApoHybridConstants.fontVerySmall.mCharCellHeight);
//@				}
//@			}
//@		}
...
//@		
//@		if (this.bUserLevel) {
//@			s = "Level "+String.valueOf(curLevel+1)+"/"+ApoHybridLevel.editorLevels.length;
//@		} else {
//@			s = "Level "+String.valueOf(curLevel+1)+"/"+this.max;
//@		}
//@		w = ApoHybridConstants.fontSmall.getLength(s);
//@		g.drawText(s, 160 - w/2, 473 - ApoHybridConstants.fontSmall.mCharCellHeight);
//@
//@		g.setColor(1f, 1f, 1f, 1f);
//@		if ((!this.bEditor) && (this.getGame().getSolvedLevel().containsKey(this.levelString))) {
//@			g.cropImage(ApoHybridConstants.iSheet, 160 + w/2 + 2, 458, 12, 12, 8 * 4 + 16 * (this.getGame().getSolvedLevel().get(this.levelString) - 1), 120 * 4, 12, 12);
//@		}
//@		
//@
//@		if (this.silver > 0) {
...
//@		
//@		g.setColor(1f, 1f, 1f, 1f);
//@		if (ApoHybridConstants.FIRST_GAME) {
...
//@			float w = ApoHybridConstants.FONT_STATISTICS.getLength(this.idleString);
//@			g.setColor(1f, 1f, 1f, 1f);
