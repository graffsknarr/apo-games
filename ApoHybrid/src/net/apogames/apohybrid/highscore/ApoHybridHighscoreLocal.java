...
//@
//@public class ApoHybridHighscoreLocal {
//@
...
//@	
//@	public ApoHybridHighscoreLocal(final ApoHybridPanel panel) {
//@		this.panel = panel;
//@		
...
//@			
//@			String s = "local";
//@			this.panel.drawString(g, s, (int)(360 - ApoHybridPanel.font.getLength(s)/2), 195, ApoHybridPanel.font);
//@			this.panel.drawString(g, "name", 260, 225, ApoHybridPanel.font);
//@			this.panel.drawString(g, "points", 400, 225, ApoHybridPanel.font);
//@			for (int i = 0; i < 5 && i < this.points.size(); i++) {
//@				this.panel.drawString(g, (i+1) + " "+this.panel.getTextfield().getCurString(), 255, 270 + 30 * i, ApoHybridPanel.game_font);
//@				s = String.valueOf(this.points.get(this.highscore.get(i)));
//@				this.panel.drawString(g, s, (int)(460 - ApoHybridPanel.font.getLength(s)), 270 + 30 * i, ApoHybridPanel.font);
//@			}
//@		}
//@	}
//@	
