...
public class ApoHybridEntityClock extends ApoHybridEntityBall {
	...
	public ApoHybridEntityClock(float x, float y, float radius, float angle, float rotateVelocity) {
