...
//@
//@public class ApoHybridTutorial {
//@
//@	private final ApoHybridTutorialHelp[] points;
//@	
...
//@	
//@	public ApoHybridTutorial(final ApoHybridTutorialHelp[] points) {
...
//@		if (this.bVisible) {
//@			g.cropImage(ApoHybridConstants.iSheet, this.curX, this.curY, 32, 32, this.points[this.curPosition].getCropX(), this.points[this.curPosition].getCropY(), 32, 32);
//@		}
//@	}
//@	
//@}
